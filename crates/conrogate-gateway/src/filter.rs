...
use conrogate_core::health::HealthChecker;
...
pub struct TrafficControlAdapter {
    pub limiter: Arc<dyn conrogate_core::traffic::Limiter>,
    pub breaker_factory: Arc<dyn conrogate_core::traffic::BreakerFactory>,
    /// 是否启用限流
...
impl TrafficControlAdapter {
    ...
    pub fn new(
        limiter: Arc<dyn conrogate_core::traffic::Limiter>,
        breaker_factory: Arc<dyn conrogate_core::traffic::BreakerFactory>,
    ) -> Self {
        Self {
            limiter,
            breaker_factory,
    ...
    pub fn with_governance_config(
        limiter: Arc<dyn conrogate_core::traffic::Limiter>,
        breaker_factory: Arc<dyn conrogate_core::traffic::BreakerFactory>,
        rate_limit: &conrogate_core::config::RateLimitConfig,
        breaker: &conrogate_core::config::BreakerConfig,
    ) -> Self {
        Self {
            limiter,
            breaker_factory,
...
impl conrogate_core::gateway::TrafficControl for TrafficControlAdapter {
...
mod tests {
    use super::*;
    use conrogate_core::config::{BreakerConfig as ContractBreakerConfig, RateLimitConfig};
    use conrogate_core::gateway::TrafficControl;
    use conrogate_core::traffic::BreakerFactory;
    use conrogate_traffic::breaker::{BreakerConfig, BreakerFactoryImpl};
    use conrogate_traffic::limiter::FixedWindowLimiter;
