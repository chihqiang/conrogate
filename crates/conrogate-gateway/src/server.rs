...
async fn refresh_blacklist_from_db(
    ...
    let repo =
        conrogate_storage::repository::ip_blacklist_repo::IpBlacklistRepoImpl::new((**db).clone());
...
impl GatewayServer {
    ...
    pub async fn from_config_with_db(
        ...
        let init_chains = match conrogate_plugins::framework::loader::build_chains(
        ...
        tokio::spawn(async move {
            ...
            loop {
                    ...
                    load_config_snapshot(config_cache.as_deref(), &db).await
                {
                    ...
                    match conrogate_plugins::framework::loader::build_chains(&registry, &bindings) {
                        Ok(chains) => {
