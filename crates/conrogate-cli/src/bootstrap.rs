...
async fn config_hot_reload_loop(
    ...
    registry: Arc<conrogate_plugins::framework::registry::PluginRegistryImpl>,
    plugin_executor: Arc<conrogate_plugins::framework::pipeline::PluginPipelineImpl>,
    blacklist: Arc<conrogate_security::blacklist::BlacklistMatcher>,
    redis_url: String,
