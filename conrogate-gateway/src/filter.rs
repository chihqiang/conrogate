...
impl TrafficControlAdapter {
    ...
    pub fn with_governance_config(
        limiter: Arc<dyn conrogate_contract::traffic::Limiter>,
        breaker_factory: Arc<dyn conrogate_contract::traffic::BreakerFactory>,
        rate_limit: &conrogate_contract::config::RateLimitConfig,
        breaker: &conrogate_contract::config::BreakerConfig,
    ) -> Self {
        Self {
            limiter,
            breaker_factory,
...
mod tests {
    use super::*;
    use conrogate_contract::config::{BreakerConfig as ContractBreakerConfig, RateLimitConfig};
    use conrogate_contract::gateway::TrafficControl;
    use conrogate_contract::traffic::BreakerFactory;
