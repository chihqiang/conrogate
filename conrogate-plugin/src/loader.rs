...
use conrogate_contract::dto::PluginBindingDto;
use conrogate_contract::plugin::Plugin;
use std::sync::Arc;

pub struct PluginLoader {
    registry: crate::registry::PluginRegistryImpl,
}

impl PluginLoader {
    pub fn new(registry: crate::registry::PluginRegistryImpl) -> Self {
        Self { registry }
    }
